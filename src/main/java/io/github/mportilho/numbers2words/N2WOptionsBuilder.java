...
public final class N2WOptionsBuilder {
    ...
    public static N2WOptionsBuilder create(WordGender gender, Properties properties, N2WLanguageRule rule) {
    ...
    public Numbers2WordsOptions build() {
        return new Numbers2WordsOptions(properties, gender, rule, unitDisplay, scaleDisplay, zeroDisplay, appendSingularUnitToZero);
    }
