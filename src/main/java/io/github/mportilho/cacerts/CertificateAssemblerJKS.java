...
public class CertificateAssemblerJKS {
    ...
    private static void attemptKeyStoreCreation(CertificateAuthorityContainer certContainer, String certName, CertificateData data) {
        ...
        try {
            createKeyStore(certContainer, certName, data, pwd);
        } catch (Exception e) {
            try {
                createKeyStore(certContainer, certName, data, null);
            } catch (Exception e1) {
    ...
    private static void createKeyStore(CertificateAuthorityContainer certContainer, String certName, CertificateData data,
