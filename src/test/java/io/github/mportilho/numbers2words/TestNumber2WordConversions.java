...
public class TestNumber2WordConversions {
    ...
    public void testConvert() throws Exception {
        Numbers2WordsParser parser = new Numbers2WordsParser(N2WOptionsBuilder.create(WordGender.MASCULINE, properties).build());
        System.out.println(parser.parse(54352231.009543459));
    }

    @Test
    public void testNumberInFullFormalFormatter() {
        N2WOptionsBuilder builder = N2WOptionsBuilder.create(WordGender.MASCULINE, properties)
...
//        Assertions.assertThat(parser.parse(209670123418L)).isEqualTo("duzentos e nove bilhões seiscentos e setenta milhões cento e vinte e três mil quatrocentos e dezoito");
